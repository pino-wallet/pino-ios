...
class SpeedUpAlertViewController: UIAlertController {
    ...
    private func setupView() {
        ...
        currentFeeView = GradientShowFeeView(titleText: activityDetailsVM.properties.formattedFeeInDollar, descriptionText: speedUpAlertVM.currentFeeTitle)
    ...
    @objc private func confirmSpeedUpTransaction() {
        switch pageStatus {
        case .transactionExist:
            self.dismiss(animated: true)
        case .somethingWrong:
