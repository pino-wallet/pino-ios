...
class ActivityInfoStackView: UIStackView {
    ...
    // MARK: - Initializers
    init(title: String, info: String? = nil, actionSheetInfo: actionsheetInfoType = (title: "", description: "", show: false), infoCustomView: UIView? = nil) {
        self.title = title
        self.info = info
    ...
    private func setupView() {
        if actionSheetInfo.show {
            titleLabel = TitleWithInfo(actionSheetTitle: actionSheetInfo.title, actionSheetDescription: actionSheetInfo.description)
