...
class ActivityDetailsHeaderView: UIView {
    ...
    private func setupStylesWithSwapMode() {
        if isSwapMode {
            ...
            fromTokenImageView.image = UIImage(named: activityDetailsVM.fromTokenImageName ?? activityDetailsVM.unVerifiedAssetIconName)
            ...
            toTokenImageView.image = UIImage(named: activityDetailsVM.toTokenImageName ?? activityDetailsVM.unVerifiedAssetIconName)
            ...
            defaultImageView.image = UIImage(named: activityDetailsVM.assetIconName ?? activityDetailsVM.unVerifiedAssetIconName)
        }
    }
