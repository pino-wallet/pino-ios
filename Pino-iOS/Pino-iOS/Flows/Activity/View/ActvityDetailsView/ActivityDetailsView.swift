...
class ActivityDetailsView: UIView {
    ...
    private func setupView() {
        ...
        activityDetailsInfoView = ActivityInfoView(activityDetailsVM: activityDetailsVM, presentActionSheet: {[weak self] actionSheet in
    ...
    private func setupConstraintsWithUIType() {
        ...
        footerContainerView.pin(.relative(.top, 24, to: activityDetailsInfoView, .bottom), .horizontalEdges(padding: 16))
        ...
        if activityDetailsVM.uiType == .unknown {
            ...
            viewEthScanButton.pin(.relative(.top, 24, to: footerContainerView, .bottom), .fixedHeight(56), .horizontalEdges(padding: 16))
        } else {
            activityDetailsInfoView.pin(.relative(.top, 16, to: activityDetailsHeader, .bottom), .horizontalEdges(padding: 16))
            viewEthScanButton.pin(.relative(.top, 24, to: activityDetailsInfoView, .bottom), .fixedHeight(56), .horizontalEdges(padding: 16))
        }
    }
    
    @objc private func openEthScan() {
