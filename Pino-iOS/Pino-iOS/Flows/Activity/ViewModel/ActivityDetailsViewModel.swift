...
class ActivityDetailsViewModel {
    ...
    @Published public var activityDetails: ActivityCellViewModel
    ...
    public var fullFromAddress: String? {
        return activityDetails.defaultActivityModel.fromAddress
    }
    
    public var fullToAddress: String? {
        return activityDetails.defaultActivityModel.toAddress
    }

	public var uiType: ActivityUIType {
        return activityDetails.uiType
	}
    
    public var pageTitle: String {
        return activityDetails.uiType.pageTitleText
    }
    ...
    private func setDetailsVM() {
        ...
        case .swap:
        self.swapDetailsVM = SwapDetailsViewModel(activityModel: activityDetails.defaultActivityModel, globalAssetsList: globalAssetsList!)
            
        case .borrow:
            return
        case .send:
        self.transfareDetailsVM = TransfareDetailsViewModel(activityModel: activityDetails.defaultActivityModel, globalAssetsList: globalAssetsList!)
    ...
    private func setupRequestTimer() {
        requestTimer = Timer.scheduledTimer(timeInterval: 12, target: self, selector: #selector(getActivityDetails), userInfo: nil, repeats: true)
    }
    
    @objc private func getActivityDetails() {
...
fileprivate extension ActivityUIType {
