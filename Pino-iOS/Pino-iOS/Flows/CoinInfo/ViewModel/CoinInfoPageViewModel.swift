...
class CoinInfoPageViewModel{
    ...
    private func getCoinInfoDetail(){
        let coinInfoModel = CoinInfoModel(assetImage: "BTC", userAmount: "12,43", coinAmount: "5,3", name: "4.98 APE", changingRate: "12,9",changingRateType: .decrease ,barrowAmount: "12,1")
        coinInfo = CoinInfoViewModel(coinInfoModel: coinInfoModel)
    }
    
    private func getHistoryList(){
        let actionsHistoryList = [
            ActionHistoryModel(actinIcon: "swap" , actionTitle: "Swap 2.4 APE -> 200 DAI", time: "20 min ago",status: .pending),
            ActionHistoryModel(actinIcon: "Borrow" , actionTitle: "Borrow 1.44 APE", time: "1 hour ago",status: .success),
