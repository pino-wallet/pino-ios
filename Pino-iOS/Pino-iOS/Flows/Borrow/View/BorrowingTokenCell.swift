...
class BorrowingTokenCell: UICollectionViewCell {
    ...
    public var progressBarColor: UIColor = UIColor.Pino.primary {
        didSet {
    ...
    private func createCircularPath() {
        let circularPath = UIBezierPath(arcCenter: CGPoint(x: 32 / 2, y: 32 / 2), radius: 14.7, startAngle: startPoint, endAngle: endPoint, clockwise: true)
