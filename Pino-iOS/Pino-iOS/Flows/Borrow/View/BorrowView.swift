...
class BorrowView: UIView {
    // MARK: - Closures
    public var presentActionsheet: (_ actionSheet: InfoActionSheet) -> Void
    ...
    init(borrowVM: BorrowViewModel, presentActionsheet: @escaping (_ actionSheet: InfoActionSheet) -> Void) {
    ...
    private func setupView() {
        ...
        selectDexProtocolView = SelectDexProtocolView(title: borrowVM.selectedDexProtocol.name, image: borrowVM.selectedDexProtocol.description, onDexProtocolTapClosure: {})
        
        healthScoreTitleAndInfoView = TitleWithInfo(actionSheetTitle: borrowVM.healthScoreTitle, actionSheetDescription: borrowVM.healthScoreTooltip)
        ...
        startBorrowView = StartBorrowingView(titleText: borrowVM.borrowTitle, descriptionText: borrowVM.borrowDescription, buttonTitleText: borrowVM.borrowTitle, didTapActionButtonClosure: {})
        startCollateralView = StartBorrowingView(titleText: borrowVM.collateralTitle, descriptionText: borrowVM.collateralDescription, buttonTitleText: borrowVM.collateralTitle, didTapActionButtonClosure: {})
        
        #warning("global assets list in mock")
        borrowDetailsView = BorrowingDetailsView(borrowingDetailsVM: BorrowingDetailsViewModel(borrowVM: borrowVM, globalAssetsList: [], borrowingType: .borrow))
        collateralDetailsView = BorrowingDetailsView(borrowingDetailsVM: BorrowingDetailsViewModel(borrowVM: borrowVM, globalAssetsList: [], borrowingType: .collateral))
