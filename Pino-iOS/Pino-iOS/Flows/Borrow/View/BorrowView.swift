...
class BorrowView: UIView {
    ...
    private func setupView() {
        ...
        borrowDetailsView = BorrowingDetailsView(borrowingDetailsVM: BorrowingDetailsViewModel(borrowVM: borrowVM, borrowingType: .borrow))
        collateralDetailsView = BorrowingDetailsView(borrowingDetailsVM: BorrowingDetailsViewModel(borrowVM: borrowVM, borrowingType: .collateral))
