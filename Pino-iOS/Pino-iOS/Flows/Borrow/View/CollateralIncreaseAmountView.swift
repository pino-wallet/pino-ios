...
class CollateralIncreaseAmountView: UIView {
    ...
    private func putMaxAmountInTextField() {
        ...
        if collateralIncreaseAmountVM.selectedToken.isEth {
            ...
            collateralIncreaseAmountVM.tokenAmount = collateralIncreaseAmountVM.selectedToken.holdAmount.sevenDigitFormat
            collateralIncreaseAmountVM.dollarAmount = collateralIncreaseAmountVM.selectedToken.holdAmountInDollor.priceFormat
        }
