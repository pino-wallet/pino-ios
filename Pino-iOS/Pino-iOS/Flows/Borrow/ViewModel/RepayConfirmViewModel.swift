    ...
    public func createRepayPendingActivity(txHash: String) {
        coreDataManager.addNewRepayActivity(
            activityModel: ActivityRepayModel(
                txHash: txHash,
                type: "repay",
                detail: RepayActivityDetails(activityProtocol: repayAmountVM.borrowVM.selectedDexSystem.type, repaidToken: ActivityTokenModel(amount: Utilities.parseToBigUInt(repayAmountVM.tokenAmount, units: .custom(selectedToken.decimal))!
                    .description, tokenID: selectedToken.id), repaidWithToken: ActivityTokenModel(amount: Utilities.parseToBigUInt(repayAmountVM.tokenAmount, units: .custom(selectedToken.decimal))!
                        .description, tokenID: selectedToken.id)),
                fromAddress: "",
                toAddress: "",
