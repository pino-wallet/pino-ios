...
class BorrowViewModel {
    // MARK: - TypeAliases
    typealias totalCollateralAmountsInDollarType = (totalAmountInDollars: BigNumber, totalBorrowableAmountInDollars: BigNumber)
    ...
    public var totalCollateralAmountsInDollar: totalCollateralAmountsInDollarType {
        ...
        for collateraledToken in collateralledTokens {
            guard let foundTokenInGlobalTokens = globalAssetsList?.first(where: { $0.id == collateraledToken.id }) else {
            ...
            let tokenTotalAmountInDollars = BigNumber(number: collateraledToken.amount, decimal: foundTokenInGlobalTokens.decimal) * foundTokenInGlobalTokens.price
        ...
        return (totalAmountInDollars: totalAmountInDollars, totalBorrowableAmountInDollars: totalBorrowableAmountInDollars)
    }
    ...
    public var totalBorrowAmountInDollars: BigNumber {
        ...
        for borrowedToken in borrowedTokens {
            ...
            let tokenBorrowedAmountInDollars = BigNumber(number: borrowedToken.amount, decimal: foundTokenInGlobalTokens.decimal) * foundTokenInGlobalTokens.price
