...
class BorrowIncreaseAmountViewModel {
    ...
    public var selectedToken: AssetViewModel = AssetViewModel(assetModel: BalanceAssetModel(id: "1", amount: "100000000000000000000", detail: Detail(id: "1", symbol: "LINK", name: "LINK", logo: "https://demo-cdn.pino.xyz/tokens/chainlink.png", decimals: 18, change24H: "230", changePercentage: "23", price: "6089213"), previousDayNetworth: "100"), isSelected: true)
