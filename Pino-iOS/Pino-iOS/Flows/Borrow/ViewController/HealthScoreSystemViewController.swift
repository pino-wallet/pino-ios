...
class HealthScoreSystemViewController: UIAlertController {
	...
	override func viewWillAppear(_ animated: Bool) {
        Web3Core.shared.getAaveERCBorrowContractDetails(tokenID: "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", amount: BigNumber(number: 20000000, decimal: 6).bigUInt, userAddress: PinoWalletManager().currentAccount.eip55Address).done { contractDetails in
...
//        Web3Core.shared.getAaveETHBorrowContractDetails(amount: BigNumber(number: "200000000000000000000", decimal: 18).bigUInt).done { contractDetails in
