...
class BorrowingBoardViewController: UIViewController {
    ...
    private func setupView() {
        ...
        borrowingBoardVM = BorrowingBoardViewModel(userBorrowingTokens: borrowVM.userBorrowingDetails?.borrowTokens.compactMap {_ in
            UserBorrowingAssetModel(tokenImage: "https://demo-cdn.pino.xyz/tokens/chainlink.png", tokenSymbol: "USDC", userBorrowingAmountInToken: "3000")
        } ?? [], borrowableTokens: [
        BorrowableAssetModel(tokenImage: "https://demo-cdn.pino.xyz/tokens/chainlink.png", tokenSymbol: "ETH", tokenAPY: "30000000000")
        ])
    ...
    private func setupNavigationBar() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(named: borrowVM.dismissIconName), style: .plain, target: self, action: #selector(dismissSelf))
    }
