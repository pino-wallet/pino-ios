...
class ApprovingLoadingView: UIView {
	...
	private func setupStyle() {
        ...
        navigationBarDismissButton.setImage(UIImage(named: approvngContractLoadingVM.dismissButtonImageName), for: .normal)
	...
	private func setupContstraint() {
        ...
        tryAgainButton.pin(.horizontalEdges(to: layoutMarginsGuide, padding: 0), .bottom(to: layoutMarginsGuide, padding: 12))
        speedUpButton.pin(.horizontalEdges(to: layoutMarginsGuide, padding: 0), .bottom(to: layoutMarginsGuide, padding: 12))
        speedUpDescriptionContainerView.pin(.horizontalEdges(to: layoutMarginsGuide, padding: 0), .relative(.bottom, -24, to:speedUpButton, .top))
