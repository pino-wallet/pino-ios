...
class ApprovingLoadingViewModel {
    ...
    @Published public var isApproved = false
    ...
    private func setupTimer() {
        requestTimer = Timer.scheduledTimer(timeInterval: 2, target: self, selector: #selector(getApproveTransaction), userInfo: nil, repeats: true)
    }
    ...
    @objc private func getApproveTransaction() {
