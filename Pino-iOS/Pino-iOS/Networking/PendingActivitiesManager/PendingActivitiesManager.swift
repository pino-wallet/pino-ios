			...
			if activity.accountAddress == walletManager.currentAccount.eip55Address {
                ...
                case .borrow:
                    ...
                    pendingActivitiesList.append(ActivityBorrowModel(
                        ...
                        detail: BorrowActivityDetails(activityProtocol: cdBorrowActivity.details.activityProtocol, token: ActivityTokenModel(amount: cdBorrowActivity.details.token.amount, tokenID: cdBorrowActivity.details.token.tokenId)),
                ...
                case .repay:
                    ...
                    pendingActivitiesList.append(ActivityRepayModel(
                        ...
                        detail: RepayActivityDetails(activityProtocol: cdRepayActivity.details.activityProtocol, repaidToken: ActivityTokenModel(amount: cdRepayActivity.details.repaid_token.amount, tokenID: cdRepayActivity.details.repaid_token.tokenId), repaidWithToken: ActivityTokenModel(amount: cdRepayActivity.details.repaid_with_token.amount, tokenID: cdRepayActivity.details.repaid_with_token.tokenId)),
