...
enum Web3Endpoint: EndpointType {
    ...
    internal var task: HTTPTask {
        switch self {
            case .hashTypeData(let eip712ReqInfo):
                
                return .requestParameters(bodyParameters: eip712ReqInfo.eip712HashReqBody, bodyEncoding: .jsonEncoding, urlParameters: nil)
        }
    }
