...
class PinoProgressView: UIView {
    ...
    private func setupView() {
        progressFullConstraint = NSLayoutConstraint(item: progressBarView, attribute: .trailing, relatedBy: .equal, toItem: progressContainerView, attribute: .trailing, multiplier: 1, constant: 0)
