...
extension CDCollateralActivityDetails {
	@nonobjc
	public class func fetchRequest() -> NSFetchRequest<CDCollateralActivityDetails> {
		NSFetchRequest<CDCollateralActivityDetails>(entityName: "CDCollateralActivityDetails")
	}

	@NSManaged
	public var activityProtocol: String
	@NSManaged
	public var activity: CDCollateralActivity?
	@NSManaged
