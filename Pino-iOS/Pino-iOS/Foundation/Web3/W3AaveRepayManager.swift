...
public struct W3AaveRepayManager: Web3HelperProtocol {
    ...
    public func getRepayERCCallData(contract: DynamicContract, tokenAddress: String, amount: BigUInt) -> Promise<String> {
        Promise<String> { seal in
            let solInvocation = contract[ABIMethodWrite.repayV3.rawValue]?(tokenAddress.eip55Address!, amount, BigUInt(Web3Core.Constants.aaveBorrowVariableInterestRate), walletManager.currentAccount.eip55Address.eip55Address!)
